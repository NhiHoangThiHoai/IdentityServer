...
namespace Server
{
    ...
    {
        public static void EnsureSeedData(IServiceCollection serviceProvider)
        {
            using (var scope = serviceProvider.BuildServiceProvider().GetRequiredService<IServiceScopeFactory>().CreateScope())
            {
